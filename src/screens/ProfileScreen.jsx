        ...
        <ScrollView className='px-8'>
          <Text className="flex text-center text-gray-800 text-2xl">
            ...
            <View className="mt-4 items-center w-full">
              ...
              <Text><Text className="font-bold text-black ">Mobile Number: </Text ><Text className=" text-black ">{user.mobileNumber}</Text></Text>
              <Text><Text className="font-bold text-black">Email Address: </Text> <Text className=" text-black ">{user.email}</Text></Text>
              {
